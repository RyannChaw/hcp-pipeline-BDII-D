...
main()
{
	...
	Subjlist="sub-234 sub-235 sub-236 sub-237 sub-238 sub-239 sub-240 sub-241 sub-242 sub-243 sub-244 sub-245 sub-246 sub-559 sub-561 sub-562 sub-563"                                    # Space delimited list of subject IDs
     ##sub-174 sub-184 sub-189sub-546 sub-547 sub-548 sub-549 sub-550 sub-551 sub-552 sub-553 sub-554 sub-555ssub-542 sub-543 sub-544 sub-545ub-541 sub-537 sub-538 sub-539 sub-540 #sub-530 sub-531 sub-532 sub-533 sub-534 sub-535 sub-536sub-001 sub-002 sub-003 sub-004 sub-005 sub-006 sub-007 sub-008 sub-009 sub-010 sub-011 sub-012 sub-013 sub-014 sub-015 sub-016 sub-017 sub-018 sub-019 sub-020 sub-021 sub-022 sub-023 sub-024 sub-025 sub-026 sub-027 sub-028 sub-029 sub-030 sub-031 sub-032 sub-033 sub-034 sub-035 sub-036 sub-037 sub-038 sub-039 sub-040 sub-041 sub-042 sub-043 sub-044 sub-045 sub-046 sub-047 sub-048 sub-049 sub-050 sub-051 sub-052 sub-053 sub-054 sub-055 sub-056 sub-057 sub-058 sub-059 sub-060 sub-061 sub-062 sub-063 sub-064 sub-065 sub-066 sub-067 sub-068 sub-069 sub-070 sub-071 sub-072 sub-073 sub-074 sub-075 sub-076 sub-077 sub-078 sub-079 sub-080 sub-081 sub-082 sub-083 sub-084 sub-085 sub-086 sub-087 sub-088 sub-089 sub-090 sub-091 sub-092 sub-093 sub-094 sub-095 sub-096 sub-097 sub-098 sub-099 sub-100sub-178 sub-179 sub-180 sub-182 sub-183 sub-184 sub-185 sub-186 sub-187 sub-188 sub-189 sub-190 sub-191 sub-400 sub-401 sub-402 sub-403 sub-404 sub-405 sub-406 sub-407 sub-408 sub-409 sub-410 sub-411 sub-412 sub-413 sub-414 sub-415 sub-416 sub-417 sub-418 sub-419 sub-420 sub-421 sub-422 sub-423 sub-424 sub-425 sub-426 sub-427 sub-428 sub-430 sub-431 sub-432 sub-433 sub-434 sub-435 sub-436 sub-437 sub-438 sub-439 sub-440 sub-441 sub-442 sub-443 sub-444 sub-445 sub-446 sub-447 sub-448 sub-449 sub-450 sub-181 sub-192 sub-193sub-194 sub-195 sub-196 sub-197 sub-198 sub-199 sub-200 sub-201sub-202 sub-203 sub-204 sub-205 sub-206 sub-207 sub-208 sub-209 sub-210sub-101 sub-102 sub-103 sub-104 sub-105 sub-106 sub-107 sub-108 sub-109 sub-110 sub-111 sub-112 sub-113 sub-114 sub-115 sub-116 sub-117 sub-118 sub-119 sub-120 sub-121 sub-122 sub-123 sub-124 sub-125 sub-126 sub-127 sub-128 sub-129 sub-130 sub-131 sub-132 sub-133 sub-134 sub-135 sub-136 sub-137 sub-138 sub-139 sub-140 sub-141 sub-142 sub-143 sub-144 sub-145 sub-146 sub-147 sub-148 sub-149 sub-150 sub-151 sub-152 sub-153 sub-154 sub-155 sub-156 sub-157 sub-158sub-218sub-219 sub-220 sub-221 sub-222 sub-223 sub-224 sub-225 sub-226 sub-227 sub-228
	...
	for Subject in $Subjlist ; do
		echo $Subject
	        ...
	        T1wInputImages=${StudyFolder}/${Subject}/ses-1/anat/${Subject}_ses-1_T1w.nii.gz
	 #${StudyFolder}/${Subject}/unprocessed/3T/T1w_MPR2/${Subject}_3T_T1w_MPR2.nii.gz
	#
	        T2wInputImages=${StudyFolder}/${Subject}/ses-1/anat/${Subject}_ses-1_T2w.nii.gz
