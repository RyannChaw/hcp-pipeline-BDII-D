...
#export MSMBINDIR="$HOME/projects/Pipelines/MSMBinaries"
export MSMBINDIR="/media/ubuntu//5a0ea278-2829-4adb-a52a-1ecb9f33a53b//home/chaw/projects/Pipelines/MSMBinaries"
export MATLAB_COMPILER_RUNTIME=/usr/local/MATLAB/MATLAB_Runtime/v93
#export FSL_FIXDIR="${HOME}/projects/fix"
export FSL_FIXDIR="/media/ubuntu//5a0ea278-2829-4adb-a52a-1ecb9f33a53b//home/chaw/projects/fix"
...
then
    if [[ -z "$SAVEHCPPIPE" ]]
    then
        export HCPPIPEDIR="/media/ubuntu//5a0ea278-2829-4adb-a52a-1ecb9f33a53b//home/chaw/projects/Pipelines"
    else
