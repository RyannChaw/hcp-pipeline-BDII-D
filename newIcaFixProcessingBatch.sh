...
DEFAULT_STUDY_FOLDER="/media/ubuntu/NCU/deng/Rawdata"
DEFAULT_SUBJECT_LIST="sub-236 sub-237 sub-238 sub-239 sub-240 sub-241 sub-242 sub-243 sub-244 sub-245 sub-246 sub-559 sub-561 sub-562 sub-563" ##sub-546 sub-547 sub-548 sub-549 sub-550 sub-551 sub-552 sub-553 sub-554 sub-555sub-219 sub-220 sub-221 sub-222 sub-223 sub-224 sub-225 sub-226 sub-227 sub-228
DEFAULT_ENVIRONMENT_SCRIPT="/media/ubuntu/5a0ea278-2829-4adb-a52a-1ecb9f33a53b/home/chaw/projects/Pipelines/Examples/Scripts/SetUpHCPPipeline.sh"
...
main() {
	...
	fMRINames="task-rest_dir-RL@task-rest_dir-LR"
	...
	ConcatNames=""
	ConcatNames="task-rest_dir-RL_LR"  ## Use space (or @) to separate concatenation groups
